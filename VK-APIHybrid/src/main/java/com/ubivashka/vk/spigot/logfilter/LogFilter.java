package com.ubivashka.vk.spigot.logfilter;
...
public class LogFilter implements Filter {
	...
	public Filter.Result checkMessage(String message) {
		if (message.startsWith("Request: https://api.vk.com/") || message.startsWith("Request: https://lp.vk.com/")
				|| message.startsWith("ERROR StatusLogger") || message.contains("lp.vk.com") || message.contains("Nag author: 'Ubivashka' of 'VK-API'")) {
